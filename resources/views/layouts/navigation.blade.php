        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @auth
                        <x-nav-link :href="$dashboardRoute" :active="request()->routeIs('teacher.dashboard') || request()->routeIs('student.dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    @endauth
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @auth
            <div class="pt-2 pb-3 space-y-1">
                <x-responsive-nav-link :href="$dashboardRoute" :active="request()->routeIs('teacher.dashboard') || request()->routeIs('student.dashboard')">
                    {{ __('Dashboard') }}
